W przyszłości zostaną otwarte wrota piekieł w acron
Zajmuje się tym instytut
Wykorzystują psioników którzy eksplorują wymiar piekieł
'Lyra' była faktyczną panią kapitan/admirał która została zaproszona do instytutu
W przeszłości była trailsetterką i znana była ze swojej skuteczności w badaniu nowych terenów
Jej załoga miała w sobie 4? zaufanych członków którzy byli jedynymi stałymi w jej ekipie
Zaufani to Lyra, x, y, z
Była headhunterką i szukała godnych kandydatów do nexusów lub explorerów
Po wielu latach eksperymenty pozwoliły na pierwszą faktyczną wyprawę do piekieł
Jako jedna z pierwszych pani Kapitan wraz ze swoimi zaufanymi wyruszyli aby wybadać i stworzyć ścieżkę dla pozostałych
